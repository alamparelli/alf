...
// PolicyFromManifest is the single authoritative mapping from a
// declared Permissions set to a runtime Policy. Changing permission
// semantics = changing this function, nowhere else.
