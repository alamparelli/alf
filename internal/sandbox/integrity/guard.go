// Package integrity is the tamper-detection facet of Sandbox (CWE-94
// mitigation, issue #121). Moved from internal/tooling during #339 (Step 3).
//
...
//
// Wire-in to Sandbox.Apply is provided via the sandbox.IntegrityChecker
// plug-point: callers that construct a Guard pass it to sandbox.New() via
// WithIntegrity, and every Apply call runs the check before installing the
// Policy. Runtime (#340) performs this wiring at daemon boot.
package integrity
