...
> **Note — 0.8.0 strict ocap.** `release/0.8.0` ships the 3-layer security model from [`docs/ARCHITECTURE-SECURITY.md`](docs/ARCHITECTURE-SECURITY.md): Layer 1 walls (Docker + AppArmor + seccomp + wazero — [#86](https://github.com/alamparelli/alf/issues/86)), Layer 2 identity (envelope-signed bundles + trust store + CRL — [#388](https://github.com/alamparelli/alf/issues/388)/[#387](https://github.com/alamparelli/alf/issues/387)/[#397](https://github.com/alamparelli/alf/issues/397)), Layer 3 ocap forge with revocation cascade ([#391](https://github.com/alamparelli/alf/issues/391)/[#392](https://github.com/alamparelli/alf/issues/392)/[#399](https://github.com/alamparelli/alf/issues/399)/[#400](https://github.com/alamparelli/alf/issues/400)/[#396](https://github.com/alamparelli/alf/issues/396)). The legacy process sandbox was razed in [#406](https://github.com/alamparelli/alf/issues/406); the daemon now boots into strict ocap by default — no flag required. The dev-window `ALF_EXPERIMENTAL` gate was retired at v0.8.0 final.
